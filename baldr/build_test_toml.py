...
def generate_config(beam_id, phase_key, P, M):
    ...
    config[beam_key_str][phase_key]["ctrl_model"] = {
        ...
        "sza": 140,
        "szp": P,
        "I2A": random_matrix(140, P),
        "I2M": random_matrix(M, 140),
        "I2M_LO": random_matrix(M, 140),
        "I2M_HO": random_matrix(M, 140),
        "M2C": random_matrix(140, M),
        "M2C_LO": random_matrix(140, M),
        "M2C_HO": random_matrix(140, M),
